<x-app-layout>
    ...
    <main class="p-4 space-y-6">
        ...
        <!-- Employees Tab -->
        <div id="employees" class="tab-content p-4 pb-20 space-y-6">
            <h2 class="text-xl font-semibold">Gestion des employés</h2>
            <div class="rounded-lg border bg-card"><div class="p-6"><h3 class="text-lg font-semibold mb-4">Ajouter un employé</h3><div class="space-y-4"><div><label class="text-sm font-medium">Prénom</label><input placeholder="Prénom" class="flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm"/></div><div><label class="text-sm font-medium">Nom</label><input placeholder="Nom" class="flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm"/></div><div><label class="text-sm font-medium">Identifiant</label><input placeholder="Identifiant unique" class="flex h-10 w-full rounded-md border bg-background px-3 py-2 text-sm"/></div><button class="inline-flex items-center justify-center h-10 px-4 py-2 rounded-md text-sm font-medium" style="background-color: var(--primary); color: var(--primary-foreground);">Créer l'employé</button></div></div></div>
        </div>
