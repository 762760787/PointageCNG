...
class PointageController extends Controller
{
    ...
    /**
     * La méthode historique n'est plus nécessaire car les données sont chargées dans index().
     * Vous pouvez la supprimer ou la laisser pour un accès direct si besoin.
     */
    public function historique()
    {
        // Redirige vers le dashboard principal qui contient l'historique
